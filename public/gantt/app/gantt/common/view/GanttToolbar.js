...
/*导入Project的弹出窗口*/
Ext.define('Common.view.MSProjectImportPanel', {
...
Ext.define("Common.view.GanttToolbar", {
    extend      : 'Ext.Toolbar',
            ...
            items :[{
                ...
                //编辑功能
                {
                    ...
                    items: [
                        ...
                        {
                            enableToggle: true,
                            id:"common-readonlybutton",
                            scope: gantt,
                            text: '只读模式',
                            pressed: false,
                            handler: function () {
                                gantt.setReadOnly(Ext.getCmp("common-readonlybutton").pressed);
                            }
                        }/*,
                        {
                            text: '任务降级',
