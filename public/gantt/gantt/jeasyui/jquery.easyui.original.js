...
(function($){
    ...
    function _115(_11b,_11c,flag,toParent){
        ...
        if(toParent && opts.checkToParent===false){if(flag==1){flag=2}};
...
//by tianjsh
                if($(window.top).width()<1025){opts.fitColumns=false}
//
...
(function($){
    ...
    function _90c(_90d,row,flag,toParent){
