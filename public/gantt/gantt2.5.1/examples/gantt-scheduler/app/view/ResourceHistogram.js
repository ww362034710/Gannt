Ext.define("MyApp.view.ResourceHistogram", {
    ...
    columnRenderer:function(a, j, resource, f, i){
        var d = resource.getInternalId(), g = this.normalGrid.getView(), c = this.allocationData[d], h = c && c.bars, e = c && c.maxBars;
        return(this.showScaleLines ? g.renderLines(this,resource) : "") + g.renderBars(this, h, d,resource) + (this.showLimitLines ? g.renderLimitLines(this, e,resource) : "")
    },
