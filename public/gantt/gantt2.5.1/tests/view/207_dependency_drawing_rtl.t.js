...
//                });
    ...
    t.it('End to Start, target before/below source', function(t){
        ...
        t.waitForTasksAndDependenciesToRender(g, function() {
            ...
            t.is(g.el.select('.sch-dependency-arrow-left').getCount(), 1, 'EndToStart #2: Should find arrow pointing left');
        })
    });
    ...
    t.it('End to Start, target before/above source', function(t){
        ...
        t.waitForTasksAndDependenciesToRender(g, function() {
            ...
            t.is(g.el.select('.sch-dependency-arrow-left').getCount(), 1, 'EndToStart #3: Should find arrow pointing left');
        })
    });
    ...
    t.it('End to Start, target after/above source', function(t){
        ...
        t.waitForTasksAndDependenciesToRender(g, function() {
            ...
            t.is(g.el.select('.sch-dependency-arrow-left').getCount(), 1, 'EndToStart #4: Should find arrow pointing left');
        })
    });
    ...
    t.it('Start to Start', function(t) {
        ...
        t.waitForTasksAndDependenciesToRender(g, function() {
            ...
            t.is(g.el.select('.sch-dependency-arrow-left').getCount(), 1, 'StartToStart: Should find arrow pointing left');
        })
    });
    ...
    t.it('End to End', function(t) {
        ...
        t.waitForTasksAndDependenciesToRender(g, function() {
            ...
            t.is(g.el.select('.sch-dependency-arrow-right').getCount(), 1, 'EndToEnd: Should find arrow pointing right');
        })
    });
    ...
    t.it('Start to End', function(t) {
        ...
        t.waitForTasksAndDependenciesToRender(g, function() {
            ...
            t.is(g.el.select('.sch-dependency-arrow-right').getCount(), 1, 'StartToEnd: Should find arrow pointing right');
        })
    });
    ...
    t.it('Start to End, target below, before source', function(t) {
        ...
        t.waitForTasksAndDependenciesToRender(g, function() {
            ...
            t.is(g.el.select('.sch-dependency-arrow-right').getCount(), 1, 'StartToEnd #2: Should find arrow pointing right');
        })
    });
});
