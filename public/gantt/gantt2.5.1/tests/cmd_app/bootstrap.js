...
Ext.Loader.addClassPathMappings({
  ...
  "Gnt": "../../js/Gnt",
  "Gnt.model.AssignmentEditing": "../../js/Gnt/widget/AssignmentGrid.js",
  "Sch": "../../../ExtScheduler2.x/js/Sch",
  "Sch.locale": "../../js/Sch/locale",
  "Sch.locale.Locale": "../../../ExtScheduler2.x/js/Sch/locale/Locale.js",
  "TestApp": "app"
});
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Gnt.field.ConstraintType": [
    "Gnt.column.constrainttype.Field"
  ],
  ...
  "TestApp.store.DependencyStore": [],
  "TestApp.store.TaskStore": [],
  "TestApp.view.Main": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "Gnt.constraint.Base": [],
  "Gnt.constraint.FinishNoEarlierThan": [
    "gntconstraint.finishnoearlierthan"
  ],
  "Gnt.constraint.FinishNoLaterThan": [
    "gntconstraint.finishnolaterthan"
  ],
  "Gnt.constraint.MustFinishOn": [
    "gntconstraint.mustfinishon"
  ],
  "Gnt.constraint.MustStartOn": [
    "gntconstraint.muststarton"
  ],
  "Gnt.constraint.StartNoEarlierThan": [
    "gntconstraint.startnoearlierthan"
  ],
  "Gnt.constraint.StartNoLaterThan": [
    "gntconstraint.startnolaterthan"
  ],
  "Gnt.data.AssignmentStore": [],
  "Gnt.data.Calendar": [],
  "Gnt.data.CalendarManager": [],
  ...
  "Gnt.field.ConstraintDate": [
    "widget.constraintdatefield"
  ],
  "Gnt.field.ConstraintType": [
    "widget.constrainttypefield"
  ],
  "Gnt.field.Dependency": [
  ...
  "Gnt.patches.Tree": [],
  "Gnt.plugin.ConstraintResolutionGui": [
    "plugin.constraintresolutiongui"
  ],
  "Gnt.plugin.DependencyEditor": [
  ...
  "Gnt.widget.ConstraintResolutionForm": [
    "widget.constraintresolutionform"
  ],
  "Gnt.widget.ConstraintResolutionWindow": [
    "widget.constraintresolutionwindow"
  ],
  "Gnt.widget.DependencyGrid": [
  ...
  "Gnt.widget.calendar.CalendarManager": [
    "widget.calendarmanager"
  ],
  "Gnt.widget.calendar.CalendarManagerWindow": [
    "widget.calendarmanagerwindow"
  ],
  "Gnt.widget.calendar.CalendarWindow": [
