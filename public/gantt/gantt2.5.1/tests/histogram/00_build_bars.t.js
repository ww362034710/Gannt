StartTest(function(t) {
    ...
    t.it('Histogram processes "r1" allocation info correctly', function (t) {
        ...
        t.is(data.bars[0].startDate, taskStore.getById(1).getStartDate(), '1st bar starts at "Task1" start date');
        t.is(data.bars[0].totalAllocation, 50, '1st bar allocation is 50%');

        t.is(data.bars[1].startDate, taskStore.getById(2).getStartDate(), '2nd bar starts at "Task2" start date');
        t.is(data.bars[1].totalAllocation, 150, '2nd bar allocation is 150%');

        t.is(data.bars[2].startDate, taskStore.getById(2).getEndDate(), '3rd bar starts at "Task2" end date');
    ...
    t.it('Histogram processes "r2" allocation info correctly', function (t) {
        ...
        t.is(data.bars[0].startDate, taskStore.getById(3).getStartDate(), '0th bar starts at "Task3" start date');
        ...
        t.is(data.bars[1].endDate, taskStore.getById(4).getStartDate(), '1st bar ends at "Task4" start date');
        ...
        t.is(data.bars[2].startDate, taskStore.getById(4).getStartDate(), '2nd bar starts at "Task4" start date');
        ...
        t.is(data.bars[3].endDate, taskStore.getById(4).getEndDate(), '3rd bar ends at "Task4" end date');
        ...
        t.is(data.bars[4].startDate, taskStore.getById(4).getEndDate(), '4th bar starts at "Task4" end date');
        t.is(data.bars[4].endDate, taskStore.getById(3).getEndDate(), '4th bar ends at "Task3" end date');
