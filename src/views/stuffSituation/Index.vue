    ...
    <div class="page-main page-demand-list">
        <div class="container-content">
            <div class="content-search-bar">
                <a-form :form="searchForm" layout="inline">
                    <a-form-item label="可用物：">
                        <a-input v-model="searchForm.stuffName" placeholder="请输入可用物名称" allowClear/>
                    </a-form-item>
        ...
        >
            <a-form :form="addForm">
                ...
                <a-form-item label="可用物id：" :label-col="{ span: 4 }" :wrapper-col="{ span: 20 }">
                    <a-input
                            allowClear
                            v-decorator="['stuffId', addFormRule.stuffId]"
                            placeholder="请填写可用物id"
                    />
                </a-form-item>
                <a-form-item label="状态/值：" :label-col="{ span: 4 }" :wrapper-col="{ span: 20 }">
                    <a-input
                            allowClear
