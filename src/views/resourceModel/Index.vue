...
export default {
    ...
    methods: {
        ...
        edit(data) {
            this.$router.push({
                name: "resourceModelEdit",
                params: {
                    tags: "添加资源模型",
                    resourceModelId: data.id
                }
            })
        },
        //删除
        del(scope) {
            ...
            this.$confirm({
                ...
                onOk() {
                    that.$http
                        .postBody('/bs/resourceModel/remove', { ids: [scope.id] })
                        .then((rst) => {
        ...
        getTableData() {
            ...
            this.$http.postBody("/bs/resourceModel/list", params).then(data => {
