    ...
    <div class='main-component addDemad-main'>
        ...
        <div class="demand-content">
            ...
            <div class="steps-one" v-show="stepsCur===0">
                <add-basic-info ref="addGoodsBasicInfo" v-if="goods !== null" :goods-model="goods"></add-basic-info>
            </div>
            <!-- 功能信息 -->
    ...
    export default {
            ...
            addHandler() {
                this.$refs.addGoodsBasicInfo.addForm.validateFields((err, values) => {
                    if(!err){
                        ...
                        this.$http
                            .postBody("/bs/goods/edit", Object.assign({}, values, {features: featureParams}))
                            .then(() => {
        ...
        created() {
            if (this.$route.params.goodsId !== undefined){
                 ...
                 * TODO 加载物资详细信息
                 */
                this.$http.postForm("/bs/goods/show", Object.assign({}, {id: this.goodsId}))
                    .then(rst => {
                        that.goods = rst.data;
                    }).catch(() => {})
                /**
                 * TODO 加载物资功能列表
                 */
                this.$http.postBody("/bs/stuffFeature/list", Object.assign({}, {stuffId: this.goodsId}))
                    .then(rst => {
