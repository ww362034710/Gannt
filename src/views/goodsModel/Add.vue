    ...
    <div class='main-component addDemad-main'>
        ...
        <div class="demand-content">
            ...
            <div class="steps-one" v-show="stepsCur===0">
                <add-basic-info ref="addGoodsBasicInfo"></add-basic-info>
            </div>
            <!-- 功能信息 -->
            <div v-show="stepsCur===1" class="lastSteps">
                <feature-info ref="addStuffFeatureInfo"></feature-info>
            </div>
        </div>
            ...
            addHandler() {
                this.$refs.addGoodsBasicInfo.addForm.validateFields((err, values) => {
                    if(!err){
                        ...
                        this.$http
                            .postBody("/bs/goodsModel/add", Object.assign({}, values, {features: featureParams}))
                            .then(() => {
