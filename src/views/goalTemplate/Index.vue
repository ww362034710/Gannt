            ...
            <div class="content-search-bar">
                <a-form :form="searchForm" layout="inline">
                    ...
                    <a-form-item>
                        ...
                        <a-button icon="plus" style="margin-left:10px" @click="ResolveSchemeTemplate.openAddPage('goal')">添加目标分解模板</a-button>
                    </a-form-item>
                </a-form>
            </div>
            <div class="content-search-result" v-auto>
                <a-table bordered :columns="columns" :pagination="pagination" :loading="loading" :dataSource="tblData" size="middle" :scroll="{y:true,x:500}" rowKey="uuid" @change="tblPagination">
                    ...
                    <div slot="action" slot-scope="scope" class="main-table-btns">
                        ...
                        <a-button type="primary" size="small" icon="eye" @click="scope.openEditPage()">编辑</a-button>
...
export default {
    ...
    methods: {
        ...
        del(scope) {
            let that = this;
            let data = { uid: scope.id, schemeId: scope.resolveSchemeId, nodeId: scope.nodeId };
            ...
            this.$confirm({
                ...
                onOk() {
                    that.$http
                        .postBody('/bs/resolveSchemeTemplate/remove', { ids: [scope.id] })
                        .then((rst) => {
        ...
        getTableData() {
            let params = Object.assign(
                this.searchForm,
                {
                    rootType: this.ResolveSchemeTemplate.GOAL_TYPE,
