                ...
                listeners:{
                    catchAll(event) {
                        ...
                        if(event.type == "transitionend"){
                            let dateObj = this.ganttInstance.taskStore.getTotalTimeSpan();
                            if(!this.startDateVal){
                                this.startDateVal = dateObj.startDate;
                                this.endDateVal = dateObj.endDate;

                                this.ganttInstance.timeAxis.setTimeSpan(this.startDateVal, this.endDateVal);
                            }
