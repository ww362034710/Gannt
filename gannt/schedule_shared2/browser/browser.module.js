import { AjaxHelper, BrowserHelper, DomHelper, EventHelper, WidgetHelper, Widget, Popup, GlobalEvents, VersionHelper } from '../../../build/schedulerpro.module.js';
...
class ExamplesApp {
    ...
    render() {
        ...
        if (me.examplesContainerEl.children.length === 0) {
            const order  = (e) => `${String(groupOrder.indexOf(e.group)).padStart(2, '0')}${e.title.trim()}`;
            examples.sort((a, b) => {
