  ...
  _createClass(ExamplesApp, [{
    ...
    value: function render() {
      var me = this,
          ...
          groupOrder = window.groupOrder || ['Basic', 'Intermediate', 'Advanced', 'Integration', 'Integration/Angular', 'Integration/React', 'Integration/Vue'];

      if (me.examplesContainerEl.children.length === 0) {
        var order = function order(e) {
          return "".concat(String(groupOrder.indexOf(e.group)).padStart(2, '0')).concat(e.title.trim());
        };
