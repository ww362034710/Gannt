...
export default class PresetStore extends Localizable(Store) {
    ...
    createRecord(data) {
        ...
        if (data.preset && !data.base) {
            VersionHelper.deprecate('Scheduler', '4.0.0', 'ViewPreset preset config replaced by base config. See https://www.bryntum.com/docs/scheduler/#guides/upgrades/3.0.0.md');
