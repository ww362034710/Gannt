...
export default class TimelineBase extends GridBase.mixin(
    ...
    onTimeAxisViewModelUpdate() {
        ...
        // if (this.isHorizontal && !this.refreshSuspended) {
     ...
     */
    getVisibleDateRange() {
        VersionHelper.deprecate('scheduler', '4.0.0', 'Deprecated in favor of `get visibleDateRange`');
...
VersionHelper.setVersion('scheduler', '3.1.6');
