    ...
    populateHeaderMenu({ column, items }) {
        ...
        if (column.sortable !== false) {
            items.sortAsc = {
                ...
                onItem      : () => me.store.sort(column.field, true)
            };
            ...
            items.sortDesc = {
                ...
                weight      : 105,
                disabled    : me.disabled,
                onItem      : () => me.store.sort(column.field, false)
            };
            ...
            if (me.multiSort && me.grid.columns.records.filter(col => col.sortable).length > 1) {
                ...
                items.multiSort = {
                    ...
                    menu        : [{
                        ...
                        weight      : 105,
                        onItem      : () => me.store.addSorter(column.field, true)
                    }, {
                        ...
                        disabled    : sorter && !sorter.ascending,
                        weight      : 105,
                        onItem      : () => me.store.addSorter(column.field, false)
                    }, {
                        text        : 'L{removeSorter}',
                        localeClass : me,
                        ...
                        weight      : 105,
                        disabled    : !sorter,
                        onItem      : () => me.store.removeSorter(column.field)
                    }]
                };
            }
        }
