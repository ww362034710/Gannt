...
export default class RowReorder extends Delayable(InstancePlugin) {
    ...
    onDragStart({ context }) {
        ...
        if (me.grid.features.cellMenu) {
            me.grid.features.cellMenu.hideContextMenu(false);
        }

        if (me.grid.features.headerMenu) {
            me.grid.features.headerMenu.hideContextMenu(false);
        }
