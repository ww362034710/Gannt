...
//import GridReactiveRendering from './mixin/GridReactiveRendering.js';
 ...
 */
export default class GridBase extends Container.mixin(
    Pluggable,
    State,
    GridElementEvents,
    GridFeatures,
    GridNavigation,
    //GridReactiveRendering,
    GridResponsive,
    GridSelection,
    GridState,
    GridSubGrids
    ...
    static get defaultConfig() {
        return {
             ...
             * });
             *
             * Please see https://bryntum.com/docs/grid/#guides/upgrades/3.1.0.md for more information.
             *
             * @deprecated 3.1.0
             * @config {Boolean}
             * @default
            ...
            // /**
            //  * Instance of Chronograph used for reactive cell rendering
            //  * @config {Object}
            //  */
            // replica : null,
    ...
    static getLKey() {
        return '6e229705-9e62-11ea-a249-d094663d5c88';
    }
    ...
    static get deprecatedEvents() {
        return {
            cellContextMenuBeforeShow : {
                ...
                message            : '`cellContextMenuBeforeShow` event is deprecated, in favor of `cellMenuBeforeShow` event. Please see https://bryntum.com/docs/grid/#guides/upgrades/3.1.0.md for more information.'
            },
            cellContextMenuShow : {
                product            : 'Grid',
                invalidAsOfVersion : '5.0.0',
                message            : '`cellContextMenuShow` event is deprecated, in favor of `cellMenuShow` event. Please see https://bryntum.com/docs/grid/#guides/upgrades/3.1.0.md for more information.'
            },
            headerContextMenuBeforeShow : {
                product            : 'Grid',
                invalidAsOfVersion : '5.0.0',
                message            : '`headerContextMenuBeforeShow` event is deprecated, in favor of `headerMenuBeforeShow` event. Please see https://bryntum.com/docs/grid/#guides/upgrades/3.1.0.md for more information.'
            },
            headerContextMenuShow : {
                product            : 'Grid',
                invalidAsOfVersion : '5.0.0',
                message            : '`headerContextMenuShow` event is deprecated, in favor of `headerMenuShow` event. Please see https://bryntum.com/docs/grid/#guides/upgrades/3.1.0.md for more information.'
            },
            contextMenuItem : {
                product            : 'Grid',
                invalidAsOfVersion : '5.0.0',
                message            : '`contextMenuItem` event is deprecated, in favor of `cellMenuItem` and `headerMenuItem` events. Please see https://bryntum.com/docs/grid/#guides/upgrades/3.1.0.md for more information.'
            },
            contextMenuToggleItem : {
                product            : 'Grid',
                invalidAsOfVersion : '5.0.0',
                message            : '`contextMenuToggleItem` event is deprecated, in favor of `cellMenuToggleItem` and `headerMenuToggleItem` events. Please see https://bryntum.com/docs/grid/#guides/upgrades/3.1.0.md for more information.'
            }
        };
    }
    ...
    template(data) {
        ...
        return TemplateHelper.tpl`
            <div>
                ...
                <div reference="virtualScrollers" class="b-virtual-scrollers" ${virtualScrollerStyle}></div>
    ...
    get rowManager() {
        ...
        return me._rowManager || (me._rowManager = new RowManager({
            ...
            listeners      : {
                ...
                //renderDone          : me.onRowManagerRenderDone,
                thisObj             : me
            }
        }));
    }
    ...
    populateCellMenu({ column, record, items }) {
        const
            me = this,
            // TODO: 'contextMenu' is deprecated. Please see https://bryntum.com/docs/grid/#guides/upgrades/3.1.0.md for more information.
            isDeprecatedFeatureUsed = me.features?.contextMenu && !me.features.contextMenu.disabled;

        if (isDeprecatedFeatureUsed && me.showRemoveRowInContextMenu && !me.readOnly && record && !record.meta.specialRow) {
...
VersionHelper.setVersion('grid', '3.1.6');
