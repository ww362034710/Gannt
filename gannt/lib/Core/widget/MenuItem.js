 ...
 *
 * May be configured with a {@link #config-checked} state which creates a checkbox which may be toggled.
 *
 * May be configured as {@link Core.widget.Widget#config-disabled}, which affects item appearance and blocks interactions.
 *
