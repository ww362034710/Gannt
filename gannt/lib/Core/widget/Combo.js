...
export default class Combo extends PickerField {
    ...
    set element(element) {
        ...
        if (me.multiSelect) {
            ...
            me.chipView = new MultiSelectChipView(Objects.merge({
                parent       : me,
    ...
    changePrimaryFilter(primaryFilter) {
        if (!(primaryFilter instanceof Filter)) {
            ...
            primaryFilter = new Filter({ id : 'primary', ...primaryFilter });
        }
