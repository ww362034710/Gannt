...
export default class ResizeMonitor {
    ...
    static addResizeListener(element, handler) {
        ...
        // Polyfill ResizeObesrver
            ...
            // Widgets usually add this class. If we are being asked to monitor
            // a naked element using the polyfill, this class must be present. 
            if (!element.closest('.b-widget')) {
                document.body.classList.add('b-no-resizeobserver');
            }
