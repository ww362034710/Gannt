 ...
 *
 * The mixin contains methods allowing to reduce call to {@link SchedulerPro/model/ProjectModel#function-propagate propagate()} method, which is
...
export default Target => class ProProjectAPI extends (Target || Base) {
    ...
    propagate() {
        return this.project.propagateAsync();
    }
